...
remap('n', "<leader>fr", builtin.lsp_references, bufopts, "Find references (LSP)")
remap('n', "<leader>fs", builtin.lsp_document_symbols, bufopts, "Find symbols (LSP)")
remap('n', "<leader>fc", builtin.lsp_incoming_calls, bufopts, "Find incoming calls (LSP)")
remap('n', "<leader>fo", builtin.lsp_outgoing_calls, bufopts, "Find outgoing calls (LSP)")
remap('n', "<leader>fi", builtin.lsp_implementations, bufopts, "Find implementations (LSP)")
